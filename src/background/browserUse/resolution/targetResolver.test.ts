...
import type { BrowserObservation, ComputerUsePageContext, ComputerUsePhase, PlannedStep } from '../../../shared/automation/automationTypes';
import { buildObservedCollections } from '../observation/collectionBuilder';
