...
import type { BrowserObservation, ComputerUseFinishedMessage, ComputerUseIntent, ComputerUseProgressMessage, ObservedElement } from '../../../shared/automation/automationTypes';
