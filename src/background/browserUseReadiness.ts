import type { BrowserUseErrorCode, ComputerUsePageContext, ComputerUsePhase } from '../shared/automationTypes';
import { isTransientObservationMessagingError } from './browserMessagingErrors';
