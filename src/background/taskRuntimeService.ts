import type { AutomationRun, AutomationRunStatus } from '../shared/automationTypes';
import { AppError, sanitizeForPersistence, toAppErrorPayload } from '../shared/appErrors';
