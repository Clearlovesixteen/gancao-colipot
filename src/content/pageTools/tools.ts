 ...
 * 处理工具执行
 */
import type { BrowserObservation, BrowserPageRegion, BrowserPageRegionType, BrowserPageState, ElementBox, ElementPurpose, ObservedElement } from '../../shared/automation/automationTypes';
